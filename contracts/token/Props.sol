...
* @dev 
*/
contract Props is ERC721, ERC721Enumerable, ERC721Burnable, AccessControl {
    ...
    constructor(uint256 _maxSupply, string memory _propsName, string memory _rareLevel)
        ERC721("Props", "Props")
    {
